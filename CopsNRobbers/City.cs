...
namespace CopsNRobbers
{
    public class City
    {
        ...
        public City(int width, int heigth, int depth, int centerLeft, int centerTop)
        {
            Height = heigth;
            Width = width;
            Depth = depth;
        ...
        public string[,,] MakeCity(int cityHeight, int cityWidth, int mapDepth, int citySelectedMap, City city)
        {
            string[,,] cityMap = new string[city.Height, city.Width, city.Depth];
            int xInt = 0;
            ...
            #region Add layers to layerList
            ...
            {
                for (int i = 0; i < cityMap.GetLength(1); i++)
                {
                    cityMap[j, i, mapDepth - 1] = layer[i].ToString();
                }
                j++;
            }
            return cityMap;
